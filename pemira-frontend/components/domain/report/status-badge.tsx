 ...
 * kuning = masih berjalan, abu = arsip. Lihat palet di globals.css.
 *
 * Tint "berjalan" sengaja dipatok ke --color-warning (#D4A72C) dan TIDAK ikut
 * bergeser ke amber saat rebrand: semantik status tidak boleh berubah hanya
 * karena warna brand berganti.
 *
 * Teksnya steel-ink di atas tint itu, bukan teks kuning: #D4A72C di atas latar
 * terang hanya ~1.9:1, jauh di bawah ambang WCAG AA 4.5:1.
 *
...
const STATUS_STYLE: Record<ReportStatus, string> = {
  DITERIMA: "bg-warning/15 text-steel-ink border-warning/50",
  DIVERIFIKASI: "bg-warning/15 text-steel-ink border-warning/50",
  DIBUAT_LAPORAN_INVESTIGASI: "bg-warning/15 text-steel-ink border-warning/50",
  MENUNGGU_PERSETUJUAN_KETUA: "bg-warning/15 text-steel-ink border-warning/50",
