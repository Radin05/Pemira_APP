        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center py-20 text-center">
            <span className="flex size-14 items-center justify-center rounded-full bg-canvas">
              <Gavel className="size-7 text-steel-deep/50" aria-hidden />
            </span>
                  ...
                  <tr key={r.id} className="hover:bg-ink/[0.015]">
                    ...
                    <td className="px-5 py-4 text-right">
                      {r.status === "MENUNGGU_PERSETUJUAN_KETUA" ? (
                        <Link
                          href={`/ketua/${r.id}`}
                          className="inline-flex items-center gap-1.5 rounded-full bg-amber px-4 py-1.5 text-xs font-semibold text-on-amber hover:bg-amber-deep"
                        >
                          Tinjau
                        </Link>
                      ) : (
